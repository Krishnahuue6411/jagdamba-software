<?php
// Sahara Electrical - Bill of Materials (bom.php)
        ...
        <div class="panel-body">
            <form id="bom-form" onsubmit="return false;">
                ...
                <div class="btn-group" style="margin-top: 10px;">
                    <button type="button" id="btn-delete" class="btn btn-danger" onclick="handleDelete()" style="display: none; flex: 1;"><i class="fa-solid fa-trash-can"></i> Delete</button>
                    <button type="button" class="btn btn-secondary" onclick="resetForm(true)" style="flex: 1;"><i class="fa-solid fa-xmark"></i> Clear All</button>
                </div>
            </form>
        </div>
    </div>
