<?php
// Sahara Electrical - Company Challan Tracking System (challan_tracking.php)
...
<script>
    ...
    async function loadAuditData() {
        ...
        // 2. Fetch consumption logs mapped to invoice details
        const resLogs = await App.api('query', {
            sql: "SELECT l.*, i.inv_date, i.wound_code FROM invoice_consumption_log l JOIN tax_invoice i ON l.inv_no = i.inv_no ORDER BY i.inv_date DESC"
        });
    ...
    function exportToPDF() {
        ...
        doc.setFontSize(16);
        doc.text("SAHARA ELECTRICAL - COMPANY CHALLAN TRACKING SYSTEM", 14, 15);
        doc.setFontSize(10);
