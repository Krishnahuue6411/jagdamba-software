<?php
// Sahara Electrical - Main Root / Login Page (index.php)
...
<head>
    ...
    <title>Sahara Electrical - Login</title>
    ...
    <style>
        body {
            ...
            background-image:
                ...
                radial-gradient(at 100% 100%, rgba(255, 159, 0, 0.06) 0px, transparent 50%);
        ...
        .btn-login {
            ...
            border-radius: 8px;
            border: none;
            background: linear-gradient(135deg, var(--primary), #e28e00);
            color: white;
            font-family: var(--font-header);
            font-weight: 700;
            font-size: 1rem;
            cursor: pointer;
            transition: var(--transition);
            box-shadow: 0 4px 15px rgba(255, 159, 0, 0.25);
            display: flex;
            align-items: center;
            justify-content: center;
            gap: 8px;
...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <h2 class="login-title">Sahara Electrical</h2>
