<?php
// Sahara Electrical - Dashboard (dashboard.php)
...
<div class="panel" style="margin-bottom: 24px;">
    ...
    <div class="panel-body" style="padding: 16px 24px;">
        <div style="display: flex; flex-wrap: wrap; gap: 14px;">
            ...
            <a href="tax_invoice.php" class="btn btn-success" style="color:#000;"><i class="fa-solid fa-file-invoice-dollar"></i> Generate Tax Invoice</a>
...
<div class="stats-grid" style="margin-bottom: 32px;">
    ...
    <div class="stat-card" style="grid-column: span 2;">
        <div class="stat-info">
            ...
            <span class="stat-value" style="color: var(--primary); text-shadow: 0 0 10px rgba(255,159,0,0.2);"><?php echo $stats['pending_machines']; ?></span>
        </div>
        <div class="stat-icon-box purple" style="background-color: rgba(255, 159, 0, 0.1); color: var(--primary);">
