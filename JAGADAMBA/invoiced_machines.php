<?php
// Sahara Electrical - Invoiced Machines Registry (invoiced_machines.php)
...
<div class="stats-grid" style="margin-bottom: 24px;">
    <div class="stat-card">
        <div class="stat-info">
            ...
            <span class="stat-value" id="stats-total-mc" style="color: var(--primary); text-shadow: 0 0 10px rgba(255,159,0,0.15);">0</span>
        </div>
        ...
        try {
            const res = await App.api('query', {
                sql: `
                    ...
                    LEFT JOIN tax_invoice ti ON im.inv_no = ti.inv_no
