<?php
// Sahara Electrical - Shared Layout & UI Framework (sidebar.php)
...
<head>
    ...
    <title>Sahara Electrical - <?php echo htmlspecialchars($pageTitle); ?></title>
        ...
        <aside id="sidebar">
            <div class="sidebar-header">
                <div class="sidebar-logo">
                    ...
                    <span>Sahara <span class="highlight">Elec</span></span>
                </div>
            ...
            <ul class="sidebar-menu">
                <li style="padding: 0 16px 6px; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px; color: rgba(255,255,255,0.2); font-weight: 700;">Registry Master</li>
                ...
                <li style="padding: 18px 16px 6px; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px; color: rgba(255,255,255,0.2); font-weight: 700; border-top: 1px solid var(--border-color); margin-top: 12px;">Reports & Stock</li>
                    ...
                    <li class="sidebar-menu-item">
                        <a href="<?php echo $item['url']; ?>" class="sidebar-link <?php echo ($activeMenuItem === $item['key']) ? 'active' : ''; ?>">
                            ...
                            <?php if ($item['key'] === 'alerts' && $alertsCount > 0): ?>
                                <span class="menu-badge" id="system-alerts-badge" style="background-color: var(--error); box-shadow: 0 0 10px rgba(239, 68, 68, 0.4);"><?php echo $alertsCount; ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                <?php endforeach; ?>
            ...
            <header class="topbar">
                <div class="page-title-section">
                    ...
                    <div class="breadcrumbs">
                        <a href="dashboard.php">Sahara System</a>
