<?php
// Jagdamba Electrical - Print Invoice Template (print.php)
...
if (!$inv_no) {
    ...
    try {
        ...
        if (empty($invoiceRows)) {
            ...
            // Always show CG POWER AND INDUSTRIAL SOLUTION LTD
            $partyName = 'CG POWER AND INDUSTRIAL SOLUTION LTD';
        }
            ...
            <div class="invoice-meta-row">
                ...
                <div class="meta-col-right">
                    <table class="meta-data-table">
                        ...
                        <?php if (!empty($invoice['show_asn'])): ?>
                        <tr>
                            <td><strong>ASN No.</strong></td>
                            <td>: <?php echo htmlspecialchars($invoice['asn_no'] ?: '-'); ?></td>
                        </tr>
                        <?php endif; ?>
                        <tr>
            ...
            <div style="flex-grow: 1; display: flex; flex-direction: column;">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%;">SAC<br>Code</th>
