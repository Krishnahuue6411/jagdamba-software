<?php
// Jagdamba Electrical - GST Records Report (gst_report.php)
...
<script>
    ...
    function groupInvoicesByInvNo(rows) {
        ...
        return Array.from(map.values()).sort((a, b) => {
            return a.inv_no.localeCompare(b.inv_no, undefined, { numeric: true, sensitivity: 'base' });
        });
    }
    ...
    function exportToPDF() {
        ...
        doc.autoTable({
            ...
            theme: 'striped',
            headStyles: {
                fillColor: [255, 159, 0], // Jagdamba Amber
                textColor: [0, 0, 0],
                fontStyle: 'bold'
            },
            alternateRowStyles: {
